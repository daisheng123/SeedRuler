...
import cv2
# 这个成功的扣下了ppt白板
srcPic = cv2.imread('/home/m608/object/yolov5_rotation-v1/zjf_eage/IMG_20211102_101042.jpg') #读取图片
...
cv2.imwrite('zjf_eage/greyPic.png', greyPic)
cv2.imwrite('zjf_eage/binary.png', binPic)
cv2.imwrite('zjf_eage/medianBlur.png', median)
...
cv2.imwrite('zjf_eage/binary2.png', cannyPic)
...
cv2.imwrite('zjf_eage/srcPic2.png', srcPic)
...
cv2.imwrite('zjf_eage/Rect.png', black)
...
cv2.imwrite('zjf_eage/shrinkedPic.png', polyPic)
cv2.imwrite('zjf_eage/dstImage.png', dstImage)
