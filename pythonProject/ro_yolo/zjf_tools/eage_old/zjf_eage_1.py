'''
https://www.icode9.com/content-1-976378.html
'''
import cv2
import math
import os
...
def getContours(img, cThr=[100,100], showCanny=False, minArea=1000, filter=0, draw =False):
    ...
    # cv2.imwrite('zjf_eage/imgGray.png', imgGray)
    # cv2.imwrite('zjf_eage/imgBlur.png', imgBlur)
    # cv2.imwrite('zjf_eage/imgCanny.png', imgCanny)
    # cv2.imwrite('zjf_eage/imgDial.png', imgDial)
    # cv2.imwrite('zjf_eage/imgThre.png', imgThre)
...
def count_pixel(image_path):
    ...
    if len(contours) != 0:
        ...
        # print(newPoints)
        # box_points=np.int0(newPoints.reshape(4,2))
        # cv2.drawContours(imgContour, box_points, 0, (0, 255, 0), 2)
