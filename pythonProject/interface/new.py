...
"}")
        ...
        self.button4.setIcon(QIcon("camera.jpg"))
        ...
        self.button6.setIcon(QIcon("save.jpg"))
        ...
        self.button7.setIcon(QIcon("p1.png"))
        ...
        self.button5.setIcon(QIcon("p2.png"))
        ...
        self.button5.clicked.connect(MainWindow.function1_click)
        self.button7.clicked.connect(MainWindow.function2_click)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "谷粒形态智能测量系统"))
        MainWindow.setWindowIcon(QIcon("tubiao.ico"))
        MainWindow.setIconSize(QSize(16,16))
        self.button1.setText(_translate("MainWindow", "打开图片"))
        self.button2.setText(_translate("MainWindow", "打开摄像头"))
        self.label_2.setText(_translate("MainWindow", "原图"))
        self.label_3.setText(_translate("MainWindow", "预览图"))
        self.label_4.setText(_translate("MainWindow", "功能选择"))
        self.button4.setText(_translate("MainWindow", "捕捉图片"))
        self.button6.setText(_translate("MainWindow", "保存结果"))
        self.button7.setText(_translate("MainWindow", "长宽测量"))
        self.button5.setText(_translate("MainWindow", "统计萌芽率"))
        self.button8.setText(_translate("MainWindow", "退出"))
        self.action.setText(_translate("MainWindow", "路径"))
