...
class My_show_1(QWidget):
    ...
    def start(self):
        ...
        code = 'python detect.py --source \"' + temp + '\" --weights runs/exp0/weights/best.pt --conf 0.4 --agnostic-nms --save-txt'
        print(code)
        os.system(code)
    ...
    def open_data(self):
        # 显示对应的数据结果
        # 获取相关路径
        openfile_name = QFileDialog.getOpenFileName(self, '选择文件', '..\inference\output',
