...
<div class="animation">
	...
	<div id="big">
	<div style="display:none" id="measureSelect">Image process</div>
			...
			<div class="layui-col-xs12 layui-col-md4">
				<div id="echarts-dataset"
					...
					<img id="resultimage" style="max-width: 100%; max-height: 100%;"
						src="resource/images/HN301-2-3.jpg">
				</div>
			</div>
				...
				<table id="data-table-total" class="layui-table"
					...
					<thead>
						<tr>
							...
							<th style="font-size: 18px">Length means(mm)</th>
							<th style="font-size: 18px">Width means(mm)</th>
							<th style="font-size: 18px">Number</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
		...
		*/
		...
		layui.use([ 'form', 'upload', 'layer' ], function() {
			...
			document.getElementById("measureButton").onclick = function() {
				...
				xhr.open("POST", "image/phenotypemeasure", true);
				xhr.onreadystatechange = function() {
					if (xhr.readyState === 4 && xhr.status === 200) {
						...
						if (response.status == "success") {
							...
							document.getElementById("average_value_width").querySelector("a").innerText = response.widthAvg.toFixed(3);
							...
							document.getElementById("average_value_height").querySelector("a").innerText = response.heightAvg.toFixed(3);
							...
							for (var i = 0; i < response.CornTotalList.length; i++) {
								...
								for (var j = 0; j < 4; j++) {
									...
									if (j % 4 == 3) {
										cellT.textContent = Number(response.CornTotalList[i].number);
									}
