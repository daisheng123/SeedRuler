...
<body>
	...
	<div id="big">
		<div style="display:none" id="measureSelect">YOLO</div>
			...
			*/
			...
			layui.use([ 'form', 'upload', 'layer', 'echarts' ], function() {
				...
				document.getElementById("measureButton").onclick = function() {
					...
					xhr.open("POST", "image/germinatemeasure", true);
